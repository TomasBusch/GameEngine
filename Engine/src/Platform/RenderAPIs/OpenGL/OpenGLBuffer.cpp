...
namespace Engine {
	...
	static void OpenGLBuffer::copy(OpenGLBuffer& readbuffer, OpenGLBuffer& writebuffer)
	{
	...
	static void OpenGLBuffer::copy(OpenGLBuffer& readbuffer, OpenGLBuffer& writebuffer, std::uintptr_t readoffset, std::uintptr_t writeoffset, std::size_t size)
	{
